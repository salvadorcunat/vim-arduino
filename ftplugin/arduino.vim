...
command! -buffer -bar ArduinoVerifyV call arduino#VerifyV()
command! -buffer -bar ArduinoUpload call arduino#Upload()
command! -buffer -bar ArduinoUploadV call arduino#UploadV()
command! -buffer -bar ArduinoSerial call arduino#Serial()
command! -buffer -bar ArduinoSerialV call arduino#SerialV()
